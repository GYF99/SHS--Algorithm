...
% name_net=['D:\研\研一\研，\何宇晴-代码+数据整理\代码材料\SOSFCD',aaa,'-adj-1000.mat'];
% name_community=['D:\研\研一\研，\何宇晴-代码+数据整理\代码材料\SOSFCD',aaa,'.dat'];
% load(name_net)
...
% save(['SOSFCD实验记录-LFR\',name],'Qglist','NMIlist','best_in_history_Qgloop','deltaTimeloop','mmdrnodespercent','mmdrnodes');        
end
Qgavg=mean(Qglist(:));
