...
for iter=1:looptime
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%name
name=['uncons_0417_Qg_NP100_',num2str(iter)];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % % 网络
...
%     adj=A;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%真实网络
load('LFR13-adj-13.mat')
load LFR13_groundtruth.txt  LFR13_groundtruth -ASCII
groundtruth=LFR13_groundtruth;   %记得修改
adj=A;
