%%%%% CFMC_Qg实验 μ=0.5-0.8 对应实验方案中的表1
clc
clear all
%运行次数
looptime=3;
...
for iter=1:looptime
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%name
name=['Football_CFMC_v2_1008_Qg_NP100_',num2str(iter)];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % % LFR网络
% 需要操作的地方，把以下三行中每行的mu05改成mu06/07/08 对应μ=0.5/0.6/0.7/0.8  
%     load('LFR网络-操作有效性验证\mu05_N1000\LFRnetwork-adj-1000.mat')
%     community=load('LFR网络-操作有效性验证\mu05_N1000\community.dat');
%     name=['0730_CFMC_Qg_mu05_',num2str(iter)];
...
%     name=['0814_CFMC_Qg_cornell_',num2str(iter)];
%     adj=A;
%     
...
%     name=['0814_CFMC_Qg_NetScience_',num2str(iter)];
%     adj=A;
%     
...
%     name=['0814_CFMC_Qg_wisconsin_',num2str(iter)];
...
%     name=['0816_CFMC_Qg_Enzymes_g163_',num2str(iter)];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    pop = inital_Brain_pop_consv5(n, c, NP,groundtruth,adj);
    fit_Qg = fitness_Qgcpp(pop,NP,adj,n,c);

    %2. the biased process used in the initialization
    bias_pop = bias_init_brain_pop_consv5( pop, c, n, NP, adj, groundtruth);
    ...
    for i=1:NP
        ...
        Xinew=bound_brain_SOSFCD_consv5(Xinew,c,n,groundtruth,adj);
        Xjnew=bound_brain_SOSFCD_consv5(Xjnew,c,n,groundtruth,adj);
    ...
    for i=1:NP
        ...
        Para_vector = bound_brain_SOSFCD_consv5(Para_vector,c,n,groundtruth,adj);
    ...
    for r=1:NP
        ...
        clean_pop(:,:,r) = bound_brain_SOSFCD_consv5(clean_pop(:,:,r),c,n,groundtruth,adj);
